...
func (d Mapper) NewDisk(_ context.Context, name string, cfg config.DiskConfig) (disk.Disk, error) {
	...
	if err := config.ValidateMaintenanceConfig(cfg.Maintenance); err != nil {
